...
exports.analyticsTracker = exports.positionManager = exports.createPositionRoutes = void 0;
const express_1 = require("express");
const position_1 = require("../trading/position");
const tracker_1 = require("../analyzer/tracker");
const riskConfig = {
...
const positionManager = new position_1.PositionManager(100000, riskConfig); // $100k starting balance
exports.positionManager = positionManager;
const analyticsTracker = new tracker_1.AnalyticsTracker();
exports.analyticsTracker = analyticsTracker;
const createPositionRoutes = () => {
    ...
    // Close a position
    router.post('/:positionId/close', (req, res) => {
        try {
            ...
            if (openPos && position.pnl !== undefined) {
                analyticsTracker.recordTrade(positionId, position.tokenID, position.entryPrice, position.entryTime, position.exitPrice, position.exitTime, position.size, position.side === 'LONG' ? 'LONG' : 'SHORT');
            }
            res.json(position);
        }
        catch (error) {
